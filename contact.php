...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($category) || empty($subject) || empty($message)) {
        ...
        // mail($college_email, "Contact Form: $subject", $message, "From: $email");
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .security-tag { background: rgba(214, 40, 40, 0.1); color: #d62828; border: 1px solid rgba(214, 40, 40, 0.3); }
        .academic-tag { background: rgba(0, 48, 73, 0.1); color: #003049; border: 1px solid rgba(0, 48, 73, 0.3); }
        .admin-tag { background: rgba(247, 127, 0, 0.1); color: #f77f00; border: 1px solid rgba(247, 127, 0, 0.3); }
        .tech-tag { background: rgba(0, 104, 55, 0.1); color: #006837; border: 1px solid rgba(0, 104, 55, 0.3); }
