<?php
// Simple database connection without requiring other files
$host = 'localhost';
...
try {
    ...
    echo "<p>Trying with your actual Config.php...</p>";
    
    // Try to include your actual Config.php
    if (file_exists('includes/Config.php')) {
        require_once 'includes/Config.php';
        require_once 'includes/Database.php';
        $pdo = Database::getConnection();
        echo "<p>Connected using your Config.php</p>";
    }
}
?>