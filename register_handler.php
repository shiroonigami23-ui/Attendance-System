...
if ($step == 2) {
    ...
    if ($reg_data['role'] == 'STUDENT') {
        ...
        // Set default password based on role (set DEFAULT_STUDENT_PASSWORD / DEFAULT_TEACHER_PASSWORD in env, or change here)
$default_password = $reg_data['role'] == 'STUDENT'
    ? (getenv('DEFAULT_STUDENT_PASSWORD') ?: 'DEFAULT_PASSWORD_PLACEHOLDER')
    : (getenv('DEFAULT_TEACHER_PASSWORD') ?: 'DEFAULT_PASSWORD_PLACEHOLDER');
